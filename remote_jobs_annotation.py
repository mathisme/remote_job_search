...
url_base= 'https://www.indeed.com/jobs?q=annotation&l=remote&explvl=entry_level&fromage=1&limit=50'
jobs = []
...
<body>
<h1>Remote job listings: Annotation</h1>
<ul>
"""
html_end = """
</ul>
...
for i in range(df.shape[0]):
    ...
    html += line
html+=html_end
file_name = "remote_jobs_annotation_{}.html".format(str(date.today()).replace('-',''))
