...
url_base = 'https://www.indeed.com/jobs?q=institutional%20researcher&l=remote&explvl=entry_level&fromage=1&limit=50'
jobs = []
err_count = 0
...
<head>
  ...
  <title>Remote IR jobs</title>
</head>
<body>
<h1>Remote Institutional Researcher job listings</h1>
<ul>
"""
html_end = """
</ul>
...
for i in range(df.shape[0]):
    ...
    html += line
html+=html_end
file_name = "remote_jobs_ir_{}.html".format(str(date.today()).replace('-',''))
